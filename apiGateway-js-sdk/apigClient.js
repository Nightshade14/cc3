...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            ...
            sessionToken: '',
            region: '',
            apiKey: "XlAOHjqUL2a2hInV0hzNiaKcjFWNhIVX9Al0L8Tb",
    ...
    var invokeUrl = 'https://ncoyzr119a.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.photosBucketKeyPut = function (params, body, additionalParams) {
        ...
        var photosBucketKeyPutRequest = {
            ...
            path: pathComponent + uritemplate('/photos/{bucket}/{key}').expand(apiGateway.core.utils.parseParametersToObject(params, ['key', 'bucket', ])),
